...
public class TokenUtil {
	...
	private static final String SECRET_KEY = "1ks72@kalAalL&A1Nr9@Ik0X$maRO42#";
	...
	public static String createToken(Usuario usuario) {
		...
		String token = Jwts.builder().setSubject(usuario.getNome()).setIssuer(EMISSOR)
				.setExpiration(new Date(System.currentTimeMillis() + EXPIRATION)).signWith(secretKey, SignatureAlgorithm.HS256)
				.compact();
